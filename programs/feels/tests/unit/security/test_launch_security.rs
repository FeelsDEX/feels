...
use crate::common::*;
use feels::state::{Market, Position, TokenType, TokenOrigin, PolicyV1};
use anchor_lang::prelude::*;

test_in_memory!(test_unbounded_liquidity_vulnerability, |ctx: TestContext| async move {
...
test_in_memory!(test_position_creation_for_tranches, |ctx: TestContext| async move {
...
test_in_memory!(test_front_running_attack_scenario, |ctx: TestContext| async move {
...
test_in_memory!(test_atomic_launch_prevents_intervention, |ctx: TestContext| async move {
...
test_in_memory!(test_reentrancy_guard_during_launch, |ctx: TestContext| async move {
...
test_in_memory!(test_deterministic_vs_twap_pricing, |ctx: TestContext| async move {
