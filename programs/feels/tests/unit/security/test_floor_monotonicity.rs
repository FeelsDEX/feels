...
async fn test_floor_price_can_only_increase() -> TestResult<()> {
    ...
    // Verify final state
    assert_eq!(floor.current_floor, 1200, "Floor should be at highest value");
...
async fn test_floor_update_attack_scenarios() -> TestResult<()> {
    ...
    let flash_deposit = 10_000_000_000; // 10x normal
...
fn test_floor_price_math_precision() {
    ...
    let test_cases = vec![
        ...
        (1_000_000_000_000_000, 999_999_999_999_999, true, "Near equal large values"),
