...
mod tests {
    ...
    #[test]
    fn test_fee_growth_inside_range() {
    ...
    #[test]
    fn test_fee_growth_below_range() {
    ...
    #[test]
    fn test_fee_growth_above_range() {
    ...
    #[test] 
    fn test_wrapping_delta_calculation() {
