...
mod tests {
    ...
    #[test]
    fn test_unbounded_liquidity_vulnerability() {
    ...
    #[test]
    fn test_position_creation_for_tranches() {
    ...
    #[test]
    fn test_front_running_attack_scenario() {
    ...
    #[test]
    fn test_atomic_launch_prevents_intervention() {
    ...
    #[test]
    fn test_reentrancy_guard_during_launch() {
    ...
    #[test]
    fn test_protocol_owned_position_management() {
    ...
    #[test]
    fn test_liquidity_recovery_mechanism() {
    ...
    #[test]
    fn test_deterministic_vs_twap_pricing() {
