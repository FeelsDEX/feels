...
test_in_memory!(
    test_floor_placement_due_no_overflow,
...
test_in_memory!(
    test_floor_placement_due_normal_case,
    |_ctx: TestContext| async move {
        let buffer = Buffer {
            market: Pubkey::default(),
            authority: Pubkey::default(),
...
test_in_memory!(
    test_buffer_tau_overflow_protection,
    |_ctx: TestContext| async move {
...
test_in_memory!(
    test_buffer_fee_collection_overflow_protection,
    |_ctx: TestContext| async move {
        let mut buffer = Buffer {
            market: Pubkey::default(),
            authority: Pubkey::default(),
