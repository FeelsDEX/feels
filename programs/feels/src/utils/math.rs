...
use ethnum::U256;
use orca_whirlpools_core::{sqrt_price_to_tick_index, tick_index_to_sqrt_price, U128};
...
pub fn add_liquidity(current_liquidity: u128, liquidity_delta: u128) -> Result<u128> {
    current_liquidity
...
pub fn subtract_liquidity(current_liquidity: u128, liquidity_delta: u128) -> Result<u128> {
    current_liquidity
...
pub fn calculate_token_out_from_sqrt_price(
    ...
    let decimal_adjustment = match token_0_decimals.cmp(&token_1_decimals) {
        ...
        std::cmp::Ordering::Equal => U256::from(1u64),
    };
