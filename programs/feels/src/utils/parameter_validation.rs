...
pub fn validate_tick_range_params(tick_lower: i32, tick_upper: i32, tick_spacing: u16) -> Result<()> {
    // Validate bounds
    require!(
...
pub fn validate_fee_distribution(buffer_tau_bps: u16, treasury_bps: u16, creator_bps: u16) -> Result<()> {
