...
mod size_assertions {
    ...
    fn test_account_sizes() {
        ...
        let checks = vec![
            ...
            (
                "PreLaunchEscrow",
                std::mem::size_of::<PreLaunchEscrow>(),
                PreLaunchEscrow::LEN - 8,
            ),
            (
                "SafetyController",
                std::mem::size_of::<SafetyController>(),
                SafetyController::LEN - 8,
            ),
            (
                "EpochParams",
                std::mem::size_of::<EpochParams>(),
                EpochParams::LEN - 8,
            ),
            (
                "FeelsHub",
            ...
            (
                ...
                ProtocolConfig::LEN - 8,
            ),
            (
                "ProtocolOracle",
                std::mem::size_of::<ProtocolOracle>(),
                ProtocolOracle::LEN - 8,
            ),
            (
                "OracleState",
        ...
        for (name, actual, expected) in checks {
            if actual != expected {
                eprintln!(
                    "{} size mismatch: actual {} vs expected {} (diff: {})",
                    name,
                    actual,
                    expected,
