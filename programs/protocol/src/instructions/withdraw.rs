...
use feelssol_controller::cpi::{
    accounts::Withdraw as FeelsSOLWithdraw, withdraw as feelssol_controller_withdraw,
};
...
pub fn withdraw_via_feelssol_controller(ctx: Context<Withdraw>, amount: u64) -> Result<()> {
    ...
    let cpi_accounts = FeelsSOLWithdraw {
    ...
    feelssol_controller_withdraw(cpi_ctx, amount)?;
