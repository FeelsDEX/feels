...
console.log(`[devbridge] Server running on ws://${DEVBRIDGE_HOST}:${DEVBRIDGE_PORT}`);
...
function broadcastToRole(role: 'cli' | 'app', msg: BridgeMsg) {
...
function routeResultToOriginator(msg: BridgeMsg & { t: 'result' }) {
