    ...
    return (
      <div id="token-not-found-container" className="container mx-auto px-4 py-8">
        <div className="flex justify-center">
          <div id="token-not-found-card" className="bg-card text-card-foreground p-6 pixel-container max-w-[500px] w-full">
            <div className="p-6 text-center">
              <h2 id="token-not-found-title" className="text-xl font-medium mb-4">Token Not Found</h2>
              <p id="token-not-found-message" className="text-muted-foreground">This token is not available on Feels Protocol.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  if (loading) {
    return (
      <div id="token-loading-container" className="container mx-auto px-4 py-8">
        <div className="flex justify-center">
          <div id="token-loading-card" className="bg-card text-card-foreground p-6 pixel-container max-w-[500px] w-full">
            <div className="flex items-center justify-center p-8">
              <div className="flex flex-col items-center space-y-4">
                <div id="token-loading-spinner" className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary"></div>
                <p id="token-loading-message" className="text-muted-foreground">Initializing Feels Protocol...</p>
              </div>
            </div>
          </div>
        </div>
  ...
  if (error) {
    return (
      <div id="token-error-container" className="container mx-auto px-4 py-8">
        <div className="flex justify-center">
          <div id="token-error-card" className="bg-card text-card-foreground p-6 pixel-container max-w-[500px] w-full">
            <div className="p-6">
              <h2 id="token-error-title" className="text-xl font-medium mb-4 flex items-center gap-2">
                <span className="text-xl">Warning</span>
                Connection Error
              </h2>
              <p id="token-error-message" className="text-muted-foreground mb-4">{error}</p>
              <button 
  ...
  return (
    <Suspense fallback={
      <div id="token-page-suspense-container" className="container mx-auto px-4 py-8">
        <div className="flex justify-center">
          <div id="token-page-suspense-card" className="bg-card text-card-foreground p-6 pixel-container max-w-[500px] w-full">
            <div className="flex items-center justify-center p-8">
              <div className="flex flex-col items-center space-y-4">
                <div id="token-page-suspense-spinner" className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary"></div>
                <p id="token-page-suspense-message" className="text-muted-foreground">Loading token page...</p>
              </div>
            </div>
          </div>
        </div>
