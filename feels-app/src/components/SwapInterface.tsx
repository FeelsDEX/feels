...
import { ALL_TOKENS } from '@/lib/testData';
...
export function SwapInterface({
  ...
  // Initialize tokens
  useEffect(() => {
    const defaultFromToken = ALL_TOKENS.find(t => t.symbol === (initialFromToken || 'SOL'));
    const defaultToToken = ALL_TOKENS.find(t => t.symbol === (initialToToken || 'USDC'));
    
    setFromToken(defaultFromToken || ALL_TOKENS[0]);
    setToToken(defaultToToken || ALL_TOKENS[1]);
