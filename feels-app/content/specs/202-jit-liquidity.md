...
- **Floor Guard**: JIT ask never below `market::Floor.get_safe_ask_tick()` (MVP: calculated in entry guards)
...
The JIT system integrates cleanly across layers. Terminology: protocol = global systems; market = per‑market systems.

**Market Oracle (GTWAP)**: JIT reads the price anchor from `market::Oracle` (GTWAP, impl: `OracleState`). This avoids coupling market logic to protocol‑level reserves.

**Market Floor**: All JIT asks respect `market::Floor`'s safe ask tick. Floor calculation is market‑local and monotonic.
...
// Note: GTWAP data accessed via market::Oracle (OracleState)
// Note: Global flow signals accessed via FlowSignals
// Note: Floor data accessed via market::Floor (calculated in entry guards)
```
...
// Oracle parameters (aligned with market::Oracle and protocol::Oracle)
...
* **Solvency**: JIT spends **τ (market buffer)** only; bid fills are burned (never resold); asks use only initial protocol allocation
* **Floor preservation**: Enforced via market::Floor: `ask_tick >= market_floor.current_floor`
...
* **Unified coordination**:
  - Market price data always from market::Oracle (OracleState)
  - Toxicity signals shared via FlowSignals
  - Floor calculations from market::Floor
...
* **Floor breach**: market::Floor enforces floor constraints across all operations
...
- [GLOSSARY.md](GLOSSARY.md) - Terms: JIT, τ (tau), toxicity, GTWAP, contrarian
- [204-pool-oracle.md](204-pool-oracle.md) - GTWAP anchor for JIT placement
- [205-floor-liquidity.md](205-floor-liquidity.md) - market::Floor provides safety bounds

**JIT Integration**:
- [203-pool-clmm.md](203-pool-clmm.md) - CLMM positions used by JIT
- [208-after-swap-pipeline.md](208-after-swap-pipeline.md) - JIT execution in swap flow
- [201-dynamic-fees.md](201-dynamic-fees.md) - FlowSignals shared component (§9)

**Funding and Capital**:
- [206-pool-allocation.md](206-pool-allocation.md) - PoolBuffer (τ) funding from fee split
- [207-bonding-curve-feels.md](207-bonding-curve-feels.md) - Initial JIT seed at graduation

**Safety and Risk**:
- [210-safety-controller.md](210-safety-controller.md) - JIT entry guards and circuit breakers
- [200-feelssol-solvency.md](200-feelssol-solvency.md) - Solvency constraints

**Configuration**:
- [209-params-and-governance.md](209-params-and-governance.md) - JIT v0 parameters
- [211-events-and-units.md](211-events-and-units.md) - JIT-related events

**Comparison**:
- [205-floor-liquidity.md](205-floor-liquidity.md) - Floor (passive) vs JIT (active) strategies
