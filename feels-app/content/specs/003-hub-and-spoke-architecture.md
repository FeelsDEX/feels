...
- Is minted through protocol vaults when users deposit JitoSOL via `enter_feelssol`
- Provides base liquidity for all pairs in the hub-and-spoke model
- Can be redeemed for JitoSOL through `exit_feelssol` instruction
- Maintains backing through protocol-controlled JitoSOL reserves
