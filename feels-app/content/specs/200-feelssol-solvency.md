---
title: "Feels Protocol Solvency"
description: "Analysis of solvency mechanics in the Feels Protocol's two-layer architecture"
...
- [GLOSSARY.md](GLOSSARY.md) - Terms: FeelsSOL, JitoSOL, solvency, pool::Floor, protocol::Oracle
- [003-hub-and-spoke-architecture.md](003-hub-and-spoke-architecture.md) - FeelsSOL as hub token

**Component Implementation**:
- [204-pool-oracle.md](204-pool-oracle.md) - pool::Oracle (GTWAP) implementation
- [205-floor-liquidity.md](205-floor-liquidity.md) - pool::Floor implementation
- [210-safety-controller.md](210-safety-controller.md) - SafetyController implementation

**Entry/Exit Operations**:
- [300-launch-sequence.md](300-launch-sequence.md) - `enter_feelssol` and `exit_feelssol` instructions

**Solvency in Practice**:
- [206-pool-allocation.md](206-pool-allocation.md) - Fee allocation to reserves
- [202-jit-liquidity.md](202-jit-liquidity.md) - JIT budget constraints
- [201-dynamic-fees.md](201-dynamic-fees.md) - Fee collection supporting solvency

**Safety Mechanisms**:
- [210-safety-controller.md](210-safety-controller.md) - Circuit breakers and degraded modes
- [209-params-and-governance.md](209-params-and-governance.md) - Protocol oracle parameters

**Related Concepts**:
- [211-events-and-units.md](211-events-and-units.md) - Solvency-related events
- [208-after-swap-pipeline.md](208-after-swap-pipeline.md) - Solvency checks in swap flow
