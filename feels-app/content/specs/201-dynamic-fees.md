...
description: "MVP pool-level dynamic fee model with base + impact computation"
...
fn calculate_biased_equilibrium(
    market_oracle: &OracleState,   // market::Oracle
    market_floor: &MarketFloor      // market::Floor
) -> i32 {
...
**Intuition**: By sharing core infrastructure like market::Oracle (OracleState), market::Floor, and FlowSignals, the fee system gains access to richer signals while reducing state duplication. The fee split includes LPs, MarketReserve, Buffer (τ), Protocol Treasury, and Creator fees for protocol tokens, with exact percentages governed by protocol params.
...
pub struct PoolState {
    ...
    pub market_oracle: Pubkey,      // market::Oracle (GTWAP, impl: OracleState)
    pub market_floor: Pubkey,       // market::Floor (calc-only, planned)
...
- [GLOSSARY.md](GLOSSARY.md) - Terms: bps, impact floor, τ (tau), rebates, warmup
- [204-pool-oracle.md](204-pool-oracle.md) - GTWAP oracle (Phase 2 equilibrium, deferred)
- [205-floor-liquidity.md](205-floor-liquidity.md) - market::Floor for safe bounds

**MVP Implementation (base + impact)**:
- [203-pool-clmm.md](203-pool-clmm.md) - Swap execution that triggers fee calculation
- [208-after-swap-pipeline.md](208-after-swap-pipeline.md) - Post-swap fee processing

**Fee Distribution**:
- [206-pool-allocation.md](206-pool-allocation.md) - How collected fees are split

**Integration with Other Systems**:
- [202-jit-liquidity.md](202-jit-liquidity.md) - JIT uses PoolBuffer funded by fees
- [200-feelssol-solvency.md](200-feelssol-solvency.md) - FlowSignals unified component (§9)

**Configuration**:
- [209-params-and-governance.md](209-params-and-governance.md) - Fee parameters and governance
- [211-events-and-units.md](211-events-and-units.md) - Fee-related events
