...
- [GLOSSARY.md](GLOSSARY.md) - Terms: FeelsSOL, mint fee, bonding curve, graduation
- [003-hub-and-spoke-architecture.md](003-hub-and-spoke-architecture.md) - Why FeelsSOL is required

**Launch Implementation Details**:
- [207-bonding-curve-feels.md](207-bonding-curve-feels.md) - Bonding curve mechanics
- [301-market-state-and-lifecycle.md](301-market-state-and-lifecycle.md) - Market phases and state machine

**Post-Launch Operations**:
- [203-pool-clmm.md](203-pool-clmm.md) - Trading on the deployed market
- [206-pool-allocation.md](206-pool-allocation.md) - How fees accumulate and are allocated
- [208-after-swap-pipeline.md](208-after-swap-pipeline.md) - What happens on each trade

**Backing and Solvency**:
- [200-feelssol-solvency.md](200-feelssol-solvency.md) - JitoSOL backing for FeelsSOL

**Safety**:
- [210-safety-controller.md](210-safety-controller.md) - Launch parameter validation

**Configuration**:
- [209-params-and-governance.md](209-params-and-governance.md) - Mint fee, expiration parameters
- [211-events-and-units.md](211-events-and-units.md) - Launch-related events