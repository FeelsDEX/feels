...
impl_instruction!(
    TransitionMarketPhaseParams,
    TRANSITION_MARKET_PHASE_DISCRIMINATOR
);
...
impl_instruction!(
    CleanupBondingCurveParams,
    CLEANUP_BONDING_CURVE_DISCRIMINATOR
);
...
impl_instruction!(
    DestroyExpiredTokenParams,
    DESTROY_EXPIRED_TOKEN_DISCRIMINATOR
);
...
impl_instruction!(
    InitializeTrancheTicksParams,
    INITIALIZE_TRANCHE_TICKS_DISCRIMINATOR
);
...
impl MarketInstructionBuilder {
    ...
    pub fn transition_market_phase(
        ...
        Ok(FeelsInstructionBuilder::new()
            ...
            .with_data(TransitionMarketPhaseParams { new_phase }.build_data()?)
            .build())
    }
    ...
    pub fn destroy_expired_token(
        ...
        Ok(FeelsInstructionBuilder::new()
            ...
            .add_readonly(solana_program::sysvar::clock::id())
            .add_readonly(spl_token::id())
            .with_data(DestroyExpiredTokenParams { refund_recipient }.build_data()?)
            .build())
    }
    ...
    pub fn initialize_tranche_ticks(
        ...
        Ok(builder
            .with_data(InitializeTrancheTicksParams { start_tick_index }.build_data()?)
            .build())
    }
