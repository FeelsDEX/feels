...
use crate::{
    ...
    instructions::{
        InitializeMarketParams, LiquidityInstructionBuilder, OpenPositionParams,
    },
    protocol::PdaBuilder,
};
...
impl LiquidityService {
    ...
    pub async fn initialize_market(
        ...
        let ix = self
            .liquidity_builder
            .initialize_market(deployer.pubkey(), token_0, token_1, params)?;
    ...
    pub async fn open_position(
        ...
        Ok(OpenPositionResult { signature, position })
    }
    ...
    // Helper methods
    fn parse_position_account(&self, _account: &Account, owner: &Pubkey) -> SdkResult<PositionInfo> {
        // Simplified parsing
        Ok(PositionInfo {
            owner: *owner,
            liquidity: 0,
