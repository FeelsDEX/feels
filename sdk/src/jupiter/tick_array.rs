...
pub fn parse_tick_array_auto(data: &[u8], tick_spacing: u16) -> Result<ParsedTickArray, crate::core::SdkError> {
    // Check minimum size
    if data.len() < 8 {
...
fn parse_tick_array_v1(data: &[u8], tick_spacing: u16) -> Result<ParsedTickArray, crate::core::SdkError> {
