...
pub fn calculate_amount_with_slippage(amount: u64, slippage_bps: u16, is_min: bool) -> SdkResult<u64> {
...
pub fn sqrt_price_to_tick(sqrt_price: u128) -> SdkResult<i32> {
    ...
    feels::utils::tick_from_sqrt_price(sqrt_price)
        .map_err(|_| SdkError::MathOverflow)
}

/// Get sqrt price from tick
pub fn tick_to_sqrt_price(tick: i32) -> SdkResult<u128> {
    feels::utils::sqrt_price_from_tick(tick)
        .map_err(|_| SdkError::MathOverflow)
}
...
mod tests {
    ...
    fn test_slippage_calculation() {
        ...
        assert_eq!(calculate_amount_with_slippage(1000, 100, true).unwrap(), 990);
        
        // Max amount with 1% slippage
        assert_eq!(calculate_amount_with_slippage(1000, 100, false).unwrap(), 1010);
