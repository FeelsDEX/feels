...
async fn main() -> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    let jitosol_mint = Pubkey::new_unique(); // Would be actual JitoSOL mint
    ...
    let market_result = client.liquidity.initialize_market(
        &deployer,
    ...
    let enter_sig = client.liquidity.enter_feelssol(
        &user,
        user_jitosol,
        user_feelssol,
    ...
    let swap_result = client.swap.swap_exact_in(
        &user,
    ...
    let position_result = client.liquidity.open_position(
        &user,
        market_result.market,
        -1000, // tick_lower
        1000,  // tick_upper
    ...
    let exit_sig = client.liquidity.exit_feelssol(
        &user,
        user_jitosol,
        user_feelssol,
